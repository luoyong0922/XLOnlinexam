	...
	<body>
		<div class="container">
			<div class="center-block" style="width:240px;margin-top:170px;">
				...
				<!-- 按钮：用于打开模态框 -->
				<button type="button" class="btn btn-primary" style="float: right;" onclick="search(0)">找回密码</button>
			</div>
                    ...
                    <span aria-hidden="true">&times;</span>
						...
						<div class="modal-body">
                            ...
                            问题答案：</label>
								...
								<input type="button" value="提交" class="btn btn-primary center-block" onclick="search(1)"></input>
							</form>
